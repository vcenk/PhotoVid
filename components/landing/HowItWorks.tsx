  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        {/* Subtle Radial Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-[1200px] h-[800px] bg-emerald-600/10 blur-[160px] rounded-full opacity-60" />
        ...
        {!shouldReduceMotion && (
          <>
            <motion.div 
              ...
              className="absolute -top-40 -right-40 w-[500px] h-[500px] bg-emerald-500/5 blur-[120px] rounded-full hidden md:block"
            />
            <motion.div 
              animate={{
                x: [0, -50, 0],
              ...
              className="absolute bottom-1/4 -left-40 w-[400px] h-[400px] bg-teal-500/5 blur-[120px] rounded-full hidden md:block"
            />
          </>
        )}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
          ...
          >
            {/* Soft perimeter glow */}
            <div className="absolute -inset-4 bg-emerald-600/10 rounded-[40px] blur-3xl opacity-50 group-hover:opacity-100 transition-opacity" />
            ...
            <div className="relative rounded-[32px] border border-white/10 bg-zinc-900/40 backdrop-blur-2xl shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)] overflow-hidden">
              ...
              <div className="p-8 md:p-10 space-y-8">
                ...
                <div className="space-y-3">
                  ...
                  <div className="min-h-[110px] w-full p-5 rounded-2xl bg-zinc-950/40 border border-white/10 text-base md:text-lg text-zinc-300 font-mono leading-relaxed transition-all focus-within:border-emerald-500/40">
                    {promptText}
                    {!shouldReduceMotion && (
                      <motion.span 
                        animate={{ opacity: [1, 0] }}
                        transition={{ duration: 0.8, repeat: Infinity }}
                        className="inline-block w-[2.5px] h-[1.1em] ml-1 bg-emerald-500 align-middle"
                      />
                    )}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-5">
                  <div className="group/tile h-28 rounded-2xl border border-dashed border-white/10 flex flex-col items-center justify-center gap-3 hover:bg-white/[0.03] hover:border-emerald-500/30 transition-all cursor-pointer">
                    <div className="p-2.5 rounded-full bg-zinc-900 border border-white/5 text-zinc-500 group-hover/tile:text-emerald-400 group-hover/tile:border-emerald-500/20 transition-colors">
                      <Upload size={20} />
                    </div>
                ...
                <motion.button 
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full py-5 rounded-2xl bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-600 bg-[length:200%_auto] animate-gradient-x text-sm font-bold text-white shadow-2xl shadow-emerald-900/20 transition-all"
                >
                  Generate 4s Loop
                </motion.button>
                    ...
                    {isGenerating ? (
                      ...
                      >
                        <motion.div 
                          ...
                          className="w-14 h-14 rounded-full bg-emerald-500/10 border border-emerald-500/30 flex items-center justify-center text-emerald-400 cursor-pointer shadow-lg shadow-emerald-500/10"
                        >
          ...
          <div className="lg:col-span-5 relative lg:pt-12">
            ...
            <div className="absolute left-8 top-12 bottom-12 w-px hidden md:block">
              ...
              <motion.div 
                ...
                className="absolute top-0 left-0 w-full bg-gradient-to-b from-emerald-600 via-teal-600 to-transparent"
              />
            </div>
            ...
            <div className="space-y-16">
              {STEPS.map((step, idx) => (
                ...
                >
                  ...
                  <div className="relative z-10 flex-shrink-0 w-16 h-16 rounded-3xl bg-zinc-900 border border-white/5 flex items-center justify-center transition-all duration-500 group-hover/step:border-emerald-500/40 group-hover/step:bg-zinc-800 group-hover/step:shadow-[0_0_20px_rgba(139,92,246,0.15)]">
                    <step.icon size={26} className="text-zinc-600 group-hover/step:text-emerald-400 transition-colors duration-500" />
                    ...
                    <div className="absolute inset-0 rounded-3xl opacity-0 group-hover/step:opacity-100 transition-opacity">
                      <div className="absolute inset-0 animate-ping rounded-3xl bg-emerald-400/10" />
                    </div>
                  </div>
            ...
            >
              <div className="inline-flex items-center gap-5 p-5 rounded-[24px] border border-white/5 bg-white/[0.02] backdrop-blur-sm group hover:border-white/10 transition-colors">
                <div className="w-12 h-12 rounded-full bg-zinc-800 flex items-center justify-center text-[10px] font-black text-emerald-500 border border-emerald-500/20 group-hover:scale-110 transition-transform">
                  NEURAL
                </div>
                <div className="pr-4">
