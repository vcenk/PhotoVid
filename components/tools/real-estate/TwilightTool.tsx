                        ...
                        {error ? (
                            ...
                            <div className="w-full max-w-4xl">
                                <BeforeAfterSlider
                                    ...
                                    beforeLabel="Daytime"
                                    afterLabel={selectedStyleData?.name || 'Twilight'}
                            ...
                            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center bg-black/40"><div className="text-center text-white"><Sun size={28} className="mx-auto mb-2 opacity-80" /><p className="text-sm font-medium">Daytime → Twilight</p></div></div>
                            </div>
                        )}
                    </div>
                </div>
